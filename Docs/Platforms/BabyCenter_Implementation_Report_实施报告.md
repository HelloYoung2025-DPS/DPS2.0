...
> **文档状态**: Historical experimental snapshot
>
> **当前证据状态**: `NOT_VERIFIED` — 所引脚本, 原始报告, 截图和 UI dump 不在当前仓库可复验范围内; 14 `SKIP`, 1 `DRY_RUN` 和 4 `STUB` 按现行硬门均不能计为 PASS.
>
> **使用边界**: 下文保留 2026-03-10 的历史实验记录, 不构成 `DEVICE_VERIFIED`, 不授权真实平台副作用.
>
> **完成日期**: 2026-03-10  
> **参照基准**: Reddit 102 操作模式  
> **验证设备**: Samsung Galaxy (R58M255GNQZ, 1080x2340)  
> **历史脚本输出**: **0 FAIL** / 82 PASS / 14 SKIP / 1 DRY_RUN / 4 STUB — 不等于现行必需门通过
...
设备: R58M255GNQZ (Samsung Galaxy, 1080x2340)
  ...
  PASS:     82  (81.2%)
  FAIL:      0  ( 0.0%)  <<< 历史脚本输出; 现行门禁仍因 SKIP/DRY_RUN/STUB 失败
  SKIP:     14  (13.9%)
  DRY_RUN:   1  ( 1.0%)
  STUB:      4  ( 4.0%)
  --------------------
...
### 3.2 SKIP 分析 (14 个, 历史脚本曾将其标为预期跳过)
