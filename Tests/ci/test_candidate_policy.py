...
EXPECTED_CONTRACT_FLOORS = {
    ...
    "control-plane-host.contract": 23,
    "control-plane-host.contract-schema": 16,
    "device-registry.contract": 4,
    "edge-local-journal.contract": 3,
    "edge-local-journal.contract-schema": 6,
    "evidence-service.contract": 6,
    "executor-gateway.contract": 12,
    "factory-artifact-builder.contract": 5,
    "factory-control-plane-host.contract": 7,
    "factory-evidence-ledger.contract": 4,
    "factory-impact-analyzer.contract": 4,
    "factory-instruction-resolver.contract": 4,
    "factory-merge-controller.contract": 4,
    "factory-release-controller.contract": 4,
    "factory-rollback-controller.contract": 4,
    "factory-trusted-runner.contract": 4,
    "factory-worktree-manager.contract": 4,
    "gbrain-projector.contract": 8,
    "interest-reducer.contract": 10,
    "memory-event-ledger.contract": 4,
    ...
    "windows-edge-supervisor.contract": 12,
...
EXPECTED_INTEGRATION_FLOORS = {
    ...
    "factory-control-plane-host.simulation": 2,
    "factory-control-plane-host.postgresql18": 4,
    "factory-evidence-ledger.crash-recovery": 2,
    "factory-evidence-ledger.postgresql18": 2,
    "factory-release-controller.simulation": 2,
    "factory-worktree-manager.git-worktree": 4,
    "factory-worktree-manager.postgresql18": 5,
    ...
    "policy-approval.integration": 40,
...
EXPECTED_INTEGRATION_TRUST = {
    ...
    "factory-control-plane-host.postgresql18": (
        "REAL_POSTGRESQL",
        frozenset(
            {
    ...
    "factory-control-plane-host.simulation": ("SIMULATION", frozenset()),
    "factory-evidence-ledger.crash-recovery": (
        "REAL_LOCAL_PROCESS",
        frozenset(),
    ),
    "factory-evidence-ledger.postgresql18": (
        "REAL_POSTGRESQL",
        frozenset({"DPS_PSQL", "DPS_TEST_POSTGRES_URI"}),
    ),
    "factory-release-controller.simulation": ("SIMULATION", frozenset()),
    "factory-worktree-manager.git-worktree": (
        "REAL_LOCAL_PROCESS",
        frozenset(),
    ),
    "factory-worktree-manager.postgresql18": (
        "REAL_POSTGRESQL",
        frozenset({"DPS_TEST_POSTGRES_URI"}),
    ),
...
EXPECTED_INTEGRATION_CATEGORIES = {
    ...
    "factory-control-plane-host.postgresql18": "Integration",
    "factory-control-plane-host.simulation": "Integration",
    "factory-evidence-ledger.crash-recovery": "Integration",
    "factory-evidence-ledger.postgresql18": "Integration",
    "factory-release-controller.simulation": "Integration",
    "factory-worktree-manager.git-worktree": "Integration",
    "factory-worktree-manager.postgresql18": "Integration",
